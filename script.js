...
const hospitalsByLocation = {
    all: [
        { name: 'Max Super Speciality Hospital, Saket', rating: 4.3, image: 'img/lagos.jpg' },
        { name: 'BLK-Max Super Speciality Hospital', rating: 4.6, image: 'img/lagos.jpg' },
        { name: 'Max Super Speciality Hospital, Vaishali', rating: 4.6, image: 'img/lagos.jpg' },
        { name: 'Max Hospital, Mohali', rating: 4.2, image: 'img/lagos.jpg' }
    ],
    delhi: [
        { name: 'Max Super Speciality Hospital, Saket', rating: 4.3, image: 'img/lagos.jpg' },
        { name: 'BLK-Max Super Speciality Hospital, Delhi', rating: 4.6, image: 'img/lagos.jpg' },
        { name: 'Max Super Speciality Hospital, Vaishali', rating: 4.6, image: 'img/lagos.jpg' }
    ],
    punjab: [
        { name: 'Max Hospital, Mohali', rating: 4.5, image: 'img/lagos.jpg' },
        { name: 'Max Super Speciality Hospital, Bathinda', rating: 4.3, image: 'img/lagos.jpg' }
    ],
    uttarakhand: [
        { name: 'Max Hospital, Dehradun', rating: 4.4, image: 'img/lagos.jpg' }
    ],
    maharashtra: [
        { name: 'Max Hospital, Mumbai', rating: 4.5, image: 'img/lagos.jpg' }
    ],
    up: [
        { name: 'Max Hospital, Lucknow', rating: 4.2, image: 'img/lagos.jpg' },
        { name: 'Max Super Speciality Hospital, Noida', rating: 4.7, image: 'img/lagos.jpg' }
    ]
};

let currentSlideIndex = 0;

function renderHospitals(location) {
    const hospitals = hospitalsByLocation[location] || hospitalsByLocation.all;
    hospitalSliderTrack.innerHTML = '';
        ...
        card.innerHTML = `
            ...
            <div class="hospital-info">
                ...
                <div class="rating">
                    ...
                    <span class="stars">★★★★${hospital.rating >= 4.5 ? '★' : '☆'}</span>
                    <span class="rating-value">${hospital.rating}</span>
                </div>
            </div>
        `;
        hospitalSliderTrack.appendChild(card);
    });
...
if (emergencySidebar) {
    emergencySidebar.addEventListener('click', () => {
        emergencySidebar.classList.toggle('expanded');
    });
}
